 ...
 *     (opponent ends at 416/404; uint32_t appended, naturally aligned)
 * Total new size (64-bit): 424 bytes.
 * Total new size (32-bit): 408 bytes (pointer fields are 4 bytes, not 8).
 * ---------------------------------------------------------------------------*/
#if __SIZEOF_POINTER__ == 8
_Static_assert(sizeof(fq_app_ctx_t) == 424u,
    "fq_app_ctx_t layout changed (64-bit host)");
#elif __SIZEOF_POINTER__ == 4
_Static_assert(sizeof(fq_app_ctx_t) == 408u,
