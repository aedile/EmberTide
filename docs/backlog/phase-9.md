...
### Test Expectations
- `test_combat_screen.c` produces `scene_combat.png` identical to python visual test #2 and #10 generated by our pre-existing `/tests/test_render.py` prototype script.
